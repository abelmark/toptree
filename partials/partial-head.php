<?php
/**
 * @author    Mark Abel & Thomas
 * @package   top-tree/partials/partial-head
 * @version   1.0
 */
...
$meta_author = "Top Tree";
$meta_site_name = get_bloginfo('name') .' - '. get_bloginfo('description');
$meta_description = get_post_meta( get_the_ID(), 'seo_description', true ) ? get_post_meta( get_the_ID(), 'seo_description', true ) : "Top Tree is a cannabis culture focused entertainment and lifestyle magazine in Western Washington.";
?>
...
<meta property="og:image" content="<?php toptree_ft_img('large'); ?>">

<!-- Twitter Meta -->
<meta name="twitter:card" content="summary"/>
<meta name="twitter:title" content="<?php wp_title('|', true, 'right'); bloginfo('name'); ?>"/>
<meta name="twitter:url" content="<?php echo the_permalink() ?>">
<meta name="twitter:site" content="@thomasvaeth"/>
<meta name="twitter:creator" content="https://twitter.com/thomasvaeth">
<meta name="twitter:domain" content="http://toptree.media"/>
<meta name="twitter:image" content="<?php toptree_ft_img('large'); ?>" />
